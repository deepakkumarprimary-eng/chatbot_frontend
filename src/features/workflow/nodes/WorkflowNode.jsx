  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow =
          "0 12px 32px rgba(13,148,136,0.55), 0 4px 8px rgba(0,0,0,0.15), inset 0 1px 0 rgba(255,255,255,0.25)";
      }}
      onMouseLeave={(e) => {
    ...
    >
      <Handle
        ...
        style={{ background: "#5eead4", width: 10, height: 10, border: "2px solid #fff" }}
      />
