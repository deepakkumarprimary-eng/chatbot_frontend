    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                const json = data.workflowJson
                    ? JSON.stringify(data.workflowJson, null, 2)
                    : "";
    ...
    return (
        <div className="container py-4" style={{ maxWidth: 860 }}>
            ...
            <p className="text-muted mb-4" style={{ fontSize: 14 }}>
                {isEdit ? "Update this workflow's name or its JSON definition."
            ...
            <Form onSubmit={handleSubmit}>
                            ...
                            <Col md={4} className="d-flex align-items-end">
                                {isEdit && (
                                    <div style={{ fontSize: 13, color: "#64748b" }}>
                                        <div>Workflow ID: <strong>{id}</strong></div>
                                    </div>
                                )}
                            </Col>
                        </Row>
                ...
                <Card className="mb-4 shadow-sm">
                    <Card.Header className="d-flex align-items-center justify-content-between bg-white border-bottom">
                        ...
                        <div className="d-flex align-items-center gap-2">
                            {nodeCount !== null && (
                                <Badge bg="primary" style={{ fontSize: 12 }}>{nodeCount} nodes</Badge>
                            )}
                            <Button size="sm" variant="outline-secondary"
                                disabled={!!jsonError || !form.workflowJson.trim()}
                                onClick={formatJson}>
                                Format JSON
                            </Button>
                        </div>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control as="textarea" rows={14}
                                ...
                                style={{
                                    ...
                                    borderColor: jsonError ? "#dc3545" : undefined,
                                    background: "#fafafa",
                                }} />
                            {jsonError
                ...
                <div className="d-flex justify-content-end gap-2">
                    <Button variant="outline-secondary" onClick={() => navigate("/workflows")} disabled={saving}>
                        Cancel
                    </Button>
